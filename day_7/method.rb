...
# One way of passing variables to the method is as an argument.
# The other way is as a global variable - prefix variable with $
# Global variables should be avoided as they can be changed from any method
...
# To access a variable inside a method to the outside scope, return it
# The only way to pass variables to and from a method is as an argument, using the return keyword OR using a global variable. Global variables are not recommended.
